...
const { extractAndCompactStructure } = require('./doc-62443-parser');
const { extractStructureWithLines } = require('./doc-62443-structure-parser');
...
function extractRequirements(params) {
    ...
    const structure = extractAndCompactStructure(block.lines);
